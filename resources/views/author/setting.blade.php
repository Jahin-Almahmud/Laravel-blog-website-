                    ...
                    <div class="row">
                        <div class="col-md-8 m-auto">
                            <div class="card-box border  border-info">
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{route('authorchange.profle.photo')}}">
                                    @csrf
                     ...
                     <div class="row">
                        <div class="col-md-8 m-auto">
                            <div class="card-box border  border-info">
                                ...
                                <form class="form-horizontal" action="{{route('authorchange.password')}}">
                                    <div class="form-group row">
