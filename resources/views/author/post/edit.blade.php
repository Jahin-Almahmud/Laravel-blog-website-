...
<div class="page-title-box">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{route('admincategory.index')}}">post</a></li>
        <li class="breadcrumb-item active"><a href=""><Strong>Edit</Strong></a></li>
    </ol>
</div>
@endsection
        ...
        <div class="col-md-7">
            <div class="card-box">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  value="{{$post->title}}" placeholder="Enter post" name="post_title">
                    </div>
                    <div class="form-group">
                        Old image
                        <img width="200" src="{{asset('storage/post')}}/{{$post->image}}" alt="not found">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input id="check" type="checkbox" name="status" value="1" {{$post->status == true ? 'checked':''}}>
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2 form-control select2-multiple" name="category[]" multiple="multiple" multiple data-placeholder="Choose ...">
                            @foreach (categories() as $category)
                                ...
                                {{$category_post->id == $category->id ? 'selected':''}}
                              @endforeach
    ...
    <div class="row mt-5 " >
        <div class="col-md-12">
            <div class="card-box">
                ...
                <div class="form-group">
                    <textarea  id="summernote" style="width: 100%;"  rows="4" cols="500" name="body">{{$post->body}}</textarea>
                </div>
            </div>
        </div>
    </div>
