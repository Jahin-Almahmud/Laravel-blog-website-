                        ...
                        <div class="contact-info">
                            ...
                            <div class="single-contact">
                                ...
                                <div class="info-box">
                                    ...
                                    <p>Your address goes here sdf</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form class="contact-form-style"  action="{{route('contact.store')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12" data-aos="fade-up" data-aos-delay="200">
                                        ...
                                        <button class="btn btn-primary mt-4" data-aos="fade-up" data-aos-delay="200" type="submit">Submit <i class="fa fa-arrow-right"></i></button>
                                    </div>
                                </div>
                            </form>
